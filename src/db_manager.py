...
class DatabaseManager:
    ...
    async def get_latest_candles(self, symbol: str, timeframe: str, limit: int = 1000) -> pd.DataFrame:
    ...
    async def check_data_integrity(self, symbol: str, timeframe: str) -> Dict[str, Any]:
        ...
        try:
            table_name = self._get_table_name(symbol)
            MIN_RECORDS_IN_SUBSET_FOR_RELIABLE_CHECK = 33
            MIN_TOTAL_RECORDS_FOR_50_PERCENT_CHECK = MIN_RECORDS_IN_SUBSET_FOR_RELIABLE_CHECK * 2
